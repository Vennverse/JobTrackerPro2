...
import { Rocket, Moon, Sun, User, Settings, LogOut, BarChart3, FileText, Briefcase, Crown, Menu, X, Plus, MessageCircle, Music } from "lucide-react";
...
export function Navbar() {
  ...
  const navItems = [
    ...
    { href: "/discover", label: "Discover", icon: Music },
