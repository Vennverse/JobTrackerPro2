      ...
      {isAuthenticated ? (
        <>
          ...
          {user?.userType === 'recruiter' ? (
            <>
              <Route path="/" component={MergedRecruiterDashboard} />
              <Route path="/recruiter-dashboard" component={MergedRecruiterDashboard} />
              <Route path="/enhanced-dashboard" component={MergedRecruiterDashboard} />
